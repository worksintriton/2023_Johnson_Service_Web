...
@Component({
  selector: 'app-resubmit-partsreplacement',
  templateUrl: './resubmit-partsreplacement.component.html',
  styleUrls: ['./resubmit-partsreplacement.component.css']
})
export class ResubmitPartsreplacementComponent implements OnInit {
