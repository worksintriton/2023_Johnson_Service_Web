...
@Component({
  selector: 'app-part-replacement',
  templateUrl: './part-replacement.component.html',
  styleUrls: ['./part-replacement.component.css']
})
export class PartReplacementComponent implements OnInit {
...
getRecords(){
  ...
  this._api.pr_oracel_data(obj).subscribe((response: any) => {
