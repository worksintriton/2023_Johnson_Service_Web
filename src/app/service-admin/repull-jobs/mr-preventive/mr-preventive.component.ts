...
@Component({
  selector: 'app-mr-preventive',
  templateUrl: './mr-preventive.component.html',
  styleUrls: ['./mr-preventive.component.css']
})
export class MrPreventiveComponent implements OnInit {
  rows:any;
  searchQR;
  access_tocken:any
  Admin_check:any;
