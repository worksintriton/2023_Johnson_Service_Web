...
@Component({
  selector: 'app-sub-admin-preventive-maintenance',
  templateUrl: './sub-admin-preventive-maintenance.component.html',
  styleUrls: ['./sub-admin-preventive-maintenance.component.css']
})
export class SubAdminPreventiveMaintenanceComponent implements OnInit {
  rows:any;
  searchQR;
  access_loc:any=[];
  data:any;
  ...
  ngOnInit(): void {
    ...
    this._api.getlist_completed_pm_subadmin(this.data).subscribe((response: any) => {
