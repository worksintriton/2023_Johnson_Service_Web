...
@Component({
  selector: 'app-sub-admin-breakdown-service',
  templateUrl: './sub-admin-breakdown-service.component.html',
  styleUrls: ['./sub-admin-breakdown-service.component.css']
})
export class SubAdminBreakdownServiceComponent implements OnInit {
  rows:any;
  searchQR;
  access_loc:any=[];
  data:any;
  ...
  this. data ={
    ...
    this._api.getbreak_down_subadmin(this.data).subscribe((response: any) => {
