...
@Component({
  selector: 'app-sub-admin-lr-service',
  templateUrl: './sub-admin-lr-service.component.html',
  styleUrls: ['./sub-admin-lr-service.component.css']
})
export class SubAdminLRServiceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._api.lr_dataget_subadmin(this.data).subscribe((response: any) => {
